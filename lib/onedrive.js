	...
	({
					...
					var v = function (o) {
						...
						e.prototype._setFileInfo = function (e) {
							...
							if (this.sourceUri) {
								...
								'Hack: give sourceFile (also sourceInputElementId required! )';
								this.uploadType = f.default.form;
								this.fileInput = e.sourceFile;
								this.fileName = e.sourceFile.name;
		...
		34: [function (L, e, t) {
				...
				i = function () {
					...
					u = "undefined" == typeof self && "undefined" != typeof process && "[object process]" === {}
