const onedriveApi = {
	...
	tokenCookie: {
		...
		set: (token, expires) =>
		{
			document.cookie = onedriveApi.tokenCookie.KEY + "=" + token + "; path=/; expires=" + expires.toUTCString() + "; " + ((document.location.protocol.toLowerCase() === "https") ? "secure; " : "SameSite=Strict; ");
		},
		getToken: () =>
		{
		...
		clear: () =>
		{
			...
			document.cookie = onedriveApi.tokenCookie.KEY + "=; path=/; expires=" + expiration.toUTCString() + "; " + ((document.location.protocol.toLowerCase() === "https") ? "secure; " : "SameSite=Strict; ");
