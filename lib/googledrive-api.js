const googledriveApi = {
	...
	tokenCookie: {
		...
		set: (token, expires) =>
		{
			document.cookie = googledriveApi.tokenCookie.KEY + "=" + token + "; path=/; expires=" + expires.toUTCString() + "; " + ((document.location.protocol.toLowerCase() === "https") ? "secure; " : "SameSite=Strict; ");
		},
		getToken: () =>
		{
		...
		clear: () =>
		{
			...
			document.cookie = googledriveApi.tokenCookie.KEY + "=; path=/; expires=" + expiration.toUTCString() + "; " + ((document.location.protocol.toLowerCase() === "https") ? "secure; " : "SameSite=Strict; ");
